...
namespace pexm {
    ...
    PPexFun::PPexFun () : ScalarVectorFunction ("ppex", 3)
    {}

    double PPexFun::scalarEval (std::vector<double const *> const &args,
    ...
    bool PPexFun::isScale(vector<bool> const &mask, vector<bool> const &fix) const
    {
      return true;
    }
